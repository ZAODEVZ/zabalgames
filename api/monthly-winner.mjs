...
export default async function handler(req) {
  ...
  // Cron auth: fail closed (see daily-cast.mjs). CRON_SECRET must be set or the endpoint
  // is disabled rather than open to public triggering. Constant-time compare.
