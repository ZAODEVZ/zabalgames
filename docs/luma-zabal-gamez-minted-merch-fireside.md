# Lu.ma prep - Minted Merch (creator track): fireside
...
## Title
```
ZABAL GAMEZ Fireside - Minted Merch: Onchain Merch for Creators
```

## Subtitle / short description
```
A creator-track fireside with Minted Merch on selling merch onchain - and what that opens up for creators.
```
...
A creator-track fireside with Minted Merch - selling merch onchain, and what that opens up for creators.

What you will take away:
- How onchain merch works, in plain terms
- What it changes for a creator selling to their audience
- Where it fits in a creator's toolkit

Format: live fireside, recorded and kept - missing it live never means missing it.

When: Sunday Jun 21, 2026, 7pm EST
Hosted by: BetterCallZaal (The ZAO) with Minted Merch
