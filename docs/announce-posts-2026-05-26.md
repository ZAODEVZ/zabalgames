...
- No crypto / web3 / onchain / blockchain language in public copy
- "Digital creators" framing instead
- "100+" for ZAO member count (never specific number)
- Under 280 chars for X-style platforms
- Tight, factual, warm
- Don't promise sponsor money beyond the $500 that landed
...
1. /zabal Farcaster first - native community, lowest stakes, builder-direct
2. @thezao next - umbrella account, ecosystem-positioned
3. @ZAOFestivals - same/next day, drives the sponsor narrative
4. @bettercallzaal - personal voice last, can quote-cast any reactions

## Spacing

Spread across 24-48 hours so each lands on its own audience. If you cast all 4 same hour they cannibalize each other.

## After posting

DM me which signups come in + I add them to data/workshop-leads.json (workshop presenters) or data/mentors.json (mentors).
