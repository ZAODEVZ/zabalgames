...
# 714 - Tyler x Zaal: ZABAL Gamez + Road to ZAOstock

> **Goal:** Lock in decisions + action items from the 2026-05-22 Google Meet call between Zaal and Tyler Stambaugh (Magnetiq founder) covering the cowork action-item tracker, ZABAL Gamez, the road-to-ZAOstock content campaign, and the Magnetiq retention methodology.

Direct follow-on to [doc 473](../473-road-to-zaostock-magnetic-portal/) - the April Magnetiq-portal spec. This call moves it from spec to a dated plan and folds in ZABAL Gamez as the on-ramp.

## Key Decisions

| # | Decision | Owner | Status |
|---|----------|-------|--------|
| 1 | **Tyler pitches Magnetiq at ZABAL Gamez** - a 30-min workshop, live-streamed then clipped | Tyler | TODO |
| 2 | **ZABAL Gamez workshop month is June** - any day works for the live pitch | Zaal | TODO |
| 3 | **Road to ZAOstock = 12 weekly content drops** - to land before Oct 3 it launches in July | Zaal | TODO |
| 4 | **ZABAL Gamez runs on Magnetiq** - the vendor/workshop library plus entry + onboarding all hosted in one Magnetiq portal | Both | TODO |
...
| 6 | **ZABAL Gamez + ZAOstock announce together** - one public post this weekend covers both | Zaal | TODO |
...
Zaal builds the ZABAL Gamez entry on Magnetiq - intro video, a poll, and an open UGC submission field (link-only, low friction).
...
ZAOstock has not been announced publicly yet - that happens this weekend, bundled with the ZABAL Gamez announcement, alongside a Farcaster spaces live stream where Zaal DJs old ZAO music for lore.
...
| 3 | Build the Zabal connector for ZABAL Gamez + Farcaster spaces | Zaal | Site / Tech | TBD |
| 4 | Create 3 ZABAL Gamez launch assets on Magnetiq: intro video, poll wording, UGC wording | Zaal | Content | TBD |
| 5 | Post the combined ZABAL Gamez + ZAOstock public announcement | Zaal | Social | 2026-05-24 |
| 6 | Go live on Farcaster spaces, DJ old ZAO music for lore | Zaal | Social | 2026-05-24 |
| 7 | Write a 1-min recap short per ZABAL Gamez workshop video, linking to YouTube | Unconfirmed | Content | TBD |
...
- **ZABAL Gamez launch date** - transcript says it is "coming up in eight days" (~2026-05-30). Loose; not set as a hard due date. Confirm.
...
- ZABAL Gamez educational vendor library hosted on Magnetiq - opt-in emails, per-vendor watch analytics.
...
- `project_tyler_stambaugh.md` - new. Tyler Stambaugh: Magnetiq founder, recurring ZABAL Gamez / ZAOstock collaborator, SNAPS methodology, doc 473 + 714.

## Also See

- [Doc 473](../473-road-to-zaostock-magnetic-portal/) - the original Magnetiq portal spec this call advances
- [Doc 701](../701-zabal-games-canonical-state/) - ZABAL Gamez canonical state
