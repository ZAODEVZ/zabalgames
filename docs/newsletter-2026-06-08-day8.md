# Year of the ZABAL - Day 159 (Mon Jun 8, 2026)

> Day 8 of ZABAL Gamez, week two opens. Written in the BetterCallZaal / Year of the ZABAL
> voice: direct, warm, builder-energy, first-person where it counts, short parallel lines,
> arcade nods, the "build is the application" refrain. Day number is the day-of-year (159 of
...
Week one is in the books, and what a start. Day 1 we hit start - yerbearserker opened on Empire Builder with one line that stuck, build the foundation before you rush, then Joshua and Plat0x took us into Bonfire and the ZABAL Bonfire bot. Ohnahji opened the creator track and got real about growing a stream. We closed the week with a fireside with Carlos that turned into half working session, half vibe-coding masterclass. And all week we ran alongside GM Farcaster's Farcaster Batches. Every session recorded and kept. To everyone who showed up - thank you. That is the whole thing.
