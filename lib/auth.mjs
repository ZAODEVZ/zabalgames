...
// Length-safe constant-time string compare. Shared by every endpoint that checks a
// shared secret (notify, win-notify, win-drain, poidh-watcher) so a token check never
// short-circuits on the first wrong byte. Import this instead of hand-rolling another
// copy - the same helper was already duplicated verbatim in four api/ files.
