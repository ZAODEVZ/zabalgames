// Vendored verbatim from @noble/secp256k1@2.3.0 (MIT, Paul Miller / paulmillr.com).
// Zero-dependency, edge-safe ESM. Do NOT hand-edit - re-vendor with `npm pack @noble/secp256k1`.
// Used by lib/siwe.mjs for ECDSA public-key recovery (SIWE wallet login).
