// Vendored verbatim from js-sha3@0.12.0 build/sha3.mjs (MIT, Chen, Yi-Cyuan).
// Self-contained ESM bundle (no external imports), edge-safe via globalThis. Ethereum keccak256.
// Do NOT hand-edit - re-vendor with `npm pack js-sha3` (use build/sha3.mjs). Used by lib/siwe.mjs.
